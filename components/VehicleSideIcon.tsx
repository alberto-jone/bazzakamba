  ...
  if (category === 'economy') {
    return (
      <svg viewBox="0 0 120 60" className={className}>
        ...
        {/* Body with Wheel Wells */}
        {/* Draw path: Start front bottom, go up hood, roof, rear, down rear, define wheel wells with arcs */}
        <path d="
          M 112 38 
          Q 112 42 108 42 L 106 42 
          A 12 12 0 0 1 82 42 
          L 38 42 
          A 12 12 0 0 1 14 42 
          L 8 42 
