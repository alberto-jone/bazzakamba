  ...
  if (submitted) {
    return (
      <div className="h-full w-full bg-white flex flex-col items-center justify-center p-8 text-center space-y-6 animate-in fade-in">
         ...
         <button 
            onClick={onFinish}
            className="w-full bg-[#007FF0] text-white font-bold py-4 rounded-xl shadow-lg mt-8"
         >
            Voltar ao Início
         </button>
      </div>
    ...
    <div className="h-full w-full bg-white flex flex-col">
      ...
      <div className="flex-1 p-8 flex flex-col items-center space-y-8">
         ...
         <div className="w-full">
            ...
            <textarea 
               className="w-full h-32 bg-gray-50 rounded-xl p-4 text-gray-900 text-sm border border-gray-200 focus:border-[#007FF0] outline-none resize-none"
         ...
         <button 
            ...
            className={`w-full py-4 rounded-xl font-bold shadow-lg transition-all ${
               rating > 0 ? 'bg-[#007FF0] text-white hover:bg-[#0066CC]' : 'bg-gray-200 text-gray-400 cursor-not-allowed'
            }`}
         >
            Enviar Avaliação
         </button>
